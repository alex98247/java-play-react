...
public class GamesAction extends play.mvc.Action.Simple {
    ...
    @Singleton
    @Inject
    public GamesAction(MetricRegistry metrics, HttpExecutionContext ec, Futures futures) {
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(GamesAction.class, "responsesTimer"));
    }
